...
public interface GqlParserVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link GqlParser#file}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFile(GqlParser.FileContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GqlParser#queryExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQueryExpr(GqlParser.QueryExprContext ctx);
	/**
	 * Visit a parse tree produced by {@link GqlParser#focusedQueryExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFocusedQueryExpr(GqlParser.FocusedQueryExprContext ctx);
	/**
	 * Visit a parse tree produced by {@link GqlParser#ambientQueryExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAmbientQueryExpr(GqlParser.AmbientQueryExprContext ctx);
	/**
